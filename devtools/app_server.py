...
if __name__ == '__main__':
    ...
    print(f"API:  http://{flask_host}:{flask_port}/api/intent")
    print(f"Odyssey: http://{flask_host}:{flask_port}/odyssey")
    print("=" * 50)
    # Security (C-02): debug=True is disabled by default.
    # Use FLASK_DEBUG=true only in isolated dev environments.
    # Use FLASK_HOST=0.0.0.0 only behind a reverse proxy (Docker/prod).
